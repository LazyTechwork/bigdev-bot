...
class AdminCommands
{
     ...
     */
    public static function ban(vk_api $client, Member $sender, int $peer_id, $attached_message, $args)
    {
        ...
        if ($args[0]->getType() == CommandArgument::$TYPE_MENTION)
            $banuser = Str::start($args[0]->getData(), "id") ? Str::substr($args[0]->getData(), 2) : Str::substr($args[0]->getData(), 4);
